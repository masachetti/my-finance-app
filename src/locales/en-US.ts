export default {
  ...
  dashboard: {
    ...
    recentTransactionsInEvent: 'Recent transactions',
  },
  transactions: {
    title: 'Transactions',
    ...
    bulkLink: 'Bulk Link',
    bulkLinkTitle: 'Link Transactions to Event',
    bulkLinkDescription: 'Select transactions to link to the event',
  ...
  subCategories: {
    ...
    namePlaceholder: 'e.g., Groceries, Restaurants, Gas',
  },
  recurrent: {
  ...
  forms: {
    transaction: {
      ...
      expense: 'Expense',
      event: 'Event',
      eventPlaceholder: 'Select an event (optional)',
      noEvent: 'No event',
      noEventsAvailable: 'No events available for this date',
    },
    budget: {
      category: 'Category',
      categoryPlaceholder: 'Select a category',
  ...
  events: {
    ...
    stats: {
      ...
      balance: 'Balance',
      transactions: 'Transactions',
      noTransactions: 'No transactions linked to this event.',
    },
    actions: {
